...
const ContactPage = () => {
  return (
   <>
                ...
                <div class="col-lg-7 col-md-12 wow fadeInUp" data-wow-delay="0.5s">
                    ...
                    <form>
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <div class="form-floating">
                                    <textarea class="form-control" placeholder="Leave a message here" id="message" style={{height:200}}></textarea>
    ...
    {/* <!-- Google Map Start --> */}
    <div class="container-xxl px-0 wow fadeIn" data-wow-delay="0.1s" style={{marginBottom:-6}}>
        <iframe class="w-100" style={{height:450}}
